...
import com.mvp.rxandroid.app.AppInfo;
...
public class HttpConfig {
    ...
    public static HttpConfig createDefault(Context context){
        ...
        config.heads.put("version", AppInfo.getVersionName());
        config.heads.put("User-Agent","Android");
        //设置自定义签名证书
        if(QiChatSSLContext.getSSLContext(context)!=null){
            config.sslSocketFactory = QiChatSSLContext.getSSLContext(context).getSocketFactory();
        }
        return config;
    }
